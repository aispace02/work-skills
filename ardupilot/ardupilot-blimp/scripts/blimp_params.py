#!/usr/bin/env python3
"""
Find Blimp parameters, optionally filtered by prefix.

Usage:
    python blimp_params.py                    # All parameters
    python blimp_params.py MAX_               # MAX parameters
    python blimp_params.py --subsystem fin    # Fin parameters
"""
...
def find_subsystem_params(prefix):
    ...
    params_file = os.path.join(script_dir, '..', '..', '..', '..', 'Blimp', 'Parameters.cpp')
